          ...
          >
            <div className="d-flex justify-content-around">
              <div className="d-inline">
                <button
                  className="btn btn-primary rounded-circle ml-3"
                  type="button"
                >
                  1
                </button>
            ...
            >
              ...
              <div className="form-check">
                ...
                >
                  <span className="badge bg-danger p-3 py-1">
                    Offer Expired
                  </span>
                </div>
                <input
            ...
            <div
              className={
                click1
                  ? "d-flex justify-content-around border-success border mb-3 border-3"
                  : "d-flex justify-content-around border border mb-3 border-3"
              }
            ...
            <div
              className={
                limited
                  ? "d-flex justify-content-around border-danger border mb-3 border-3"
                  : "d-flex justify-content-around border-warning border mb-3 border-3"
              }
